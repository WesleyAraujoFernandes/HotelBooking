...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response> handleAllUnknownException(Exception e) {
        Response response = Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value()).message(e.getMessage())
                .build();
    ...
    public ResponseEntity<Response> handleInvalidCredentialsException(Exception e) {
        Response response = Response.builder().status(HttpStatus.UNAUTHORIZED.value()).message(e.getMessage()).build();
    ...
    public ResponseEntity<Response> handleInvalidBookingStateAndDateException(Exception e) {
        Response response = Response.builder().status(HttpStatus.BAD_GATEWAY.value()).message(e.getMessage()).build();
